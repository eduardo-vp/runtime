...
private:
    ...
    // case of a single code pointer. When multiple threads are jitting simultaneously, we want to
    // avoid allocations while taking m_CodeHeapLock to reduce contention.
