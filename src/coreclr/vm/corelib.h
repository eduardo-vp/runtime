...
DEFINE_FIELD(ASYNC_DISPATCHER_INFO,     NEXT,               Next)
DEFINE_FIELD(ASYNC_DISPATCHER_INFO,     NEXT_CONTINUATION,  NextContinuation)
DEFINE_FIELD(ASYNC_DISPATCHER_INFO,     CURRENT_TASK,       CurrentTask)
